$(document).ready(function() {
    ...
    $(".add-post-btn").click(function(e) {
        ...
        e.preventDefault();
        var postText = $(".fr-element p").html();
        ...
        if (postHeading.length == 0) {
            ...
            $("#post-card-section").append("<div class='post-card card w-75'><div class='card-body'>" +
                "<h5 class='card-title' >" + postHeading + "</h5> <p class='card-text'>" + postText + "</p > " +
    ...
    $("body").on('click', '.btn-edit', function() {
        var postHeading = $(".post-area-heading").val();
        var postText = $(".fr-element p").text();
    ...
    $("body").on('click', '.btn-update', function() {
        ...
        $(this).parents('div.post-card').find('.card-text').text(postContent);
